...
<div>
    ...
    <div style="width:100%;">
        <table id="district-table" class="table table-striped table-bordered table-striped" style="width:100%;">
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <tr>
                    <form action="{{URL::to('district/adddistrict/')}}" method="POST">
                        {{ csrf_field() }}
                        <td></td>
                ...
                @foreach ($district as $value)
                    <tr>
                        ...
                        <td>{{$value->name}}</td>
                        <td>
                            <a class="btn btn-danger" href="{{URL::to('district/deletedistrict/'.$value->id)}}" >Delete</a>
        ...
        <div class="modal fade" id="updateModal" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <form name="updatedistrict" action="{{URL::to('district/updatedistrict')}}" method="POST">
                    {{ csrf_field() }}
                    <div class="modal-body">
                            <p>Enter new district's name:</p>
