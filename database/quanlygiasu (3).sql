...
CREATE TABLE `evaluation` (
  ...
  `Attire` int(1) NOT NULL,
  `description` varchar(255) DEFAULT NULL,
  `punctuality` int(1) NOT NULL,
  `assignlessions` int(1) NOT NULL,
  `teachingpreparation` int(1) NOT NULL,
  `friendliness` int(1) NOT NULL,
  `funactivities` int(1) NOT NULL,
...
INSERT INTO `evaluation` (`id`, `username`, `date`, `teacher`, `time`, `school`, `class`, `Attire`, `description`, `punctuality`, `assignlessions`, `teachingpreparation`, `friendliness`, `funactivities`, `atmosphere`) VALUES
(1, 'admin', '2020-12-10', 'vpsmevivu', '12:33:00', 'Phan Bội Châu', '12', 1, NULL, 0, 1, 0, 1, 0, 0),
(3, 'admin', '2020-12-10', 'vpsmevivu', '13:30:00', 'Phan Bội Châu', '12', 0, NULL, 0, 0, 1, 2, 1, 0);
...
INSERT INTO `schoolschedule` (`id`, `tag`, `date`, `school`, `from`, `to`, `teacher`, `teacher_assistant`, `class`, `course`, `room`, `book`, `note_teacher`, `note_school`, `status`) VALUES
(2, 'Kira dep trai vcl', '2020-09-24', 'Nguyễn Khuyến', '12:34:00', '13:09:00', 'Lê văn a', 'Đào Xuân Thứ', '12', 'EIP grade 4', '32', 'Family and friends 2', '123', '123', 1);
...
INSERT INTO `School_list` (`id`, `name`, `prodate`, `lastupdate`, `staffname`, `schooltype`, `district`, `followup`, `intro`, `status`) VALUES
(2, 'Phan Bội Châu', '2020-09-08', '2020-09-09 17:00:00', 'Lê Văn Luyện', 'Primary School', 'Thủ Đức', 'Ra xã hội làm ăn bươn trải, cần cù bù siêng lăng.\r\nChỉ có nàm thì mới có ăn, không nàm mà đòi có ăn thì ăn đầu b***, ăn c**\r\nLói nhanh cho ló vuông', '', 0),
(3, 'Trương Vương', '2020-09-28', '2020-09-09 17:00:00', 'Lê Văn Luyện', 'Primary School', '5', 'Giới thiệu về trường học', '', 0),
(4, 'Nguyễn Khuyến', '2020-07-15', '2020-09-09 17:00:00', 'Athony Bui', 'High School', '10', 'Hello\r\nCô ni\r\n- Nội dung\r\n- xiN CHÀO', '', 0),
(5, 'Trường THPT cắt MOI', '2020-12-03', '2020-09-24 05:27:58', 'admin', 'Facebook', 'Facebook', 'hihihi', NULL, 1);
